  ...
  return (
    <>
      ...
      <div className="flex grid place-items-center m-4 grid-cols-4">
        <Link href="/about">
          <a>{content.nav.about.name}</a>
        </Link>

        <div
          className="flex flex-row items-center w-full px-4 py-2 mt-2 text-sm font-semibold text-left bg-transparent rounded-lg md:w-auto md:inline md:mt-0 md:ml-4 relative"
          onClick={() => {
